<?php
/**
 * Template Name: Fintech new design
 */
               ...
               <section class="related-cases_grid">
                    ...
                    <?php // set up post object
						...
						$post = $post_object;
				   		...
				   		$case_text = get_field('three_case_text');
						setup_postdata($post);
...
// 						print_r ($post);
						...
						<div class="case-item" style="background-color: <?php echo $case_bg ?>">
							...
							<div class="hidden-text">
								<?php echo $case_text; ?>
								<a href="<?php the_permalink(); ?>" class="case-item_btn">Read more</a>
							</div>
<!-- 							<div class="case-item_read"></div> -->
						</div>
