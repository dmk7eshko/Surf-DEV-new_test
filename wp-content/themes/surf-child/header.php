...
<header class="sticky-head new-header">
	<div class="container">
		<div class="head">
			<div class="logo">
				<a href="/"> <img src="https://surf.dev/wp-content/uploads/2023/05/logo-white.svg" alt=""> </a>
			</div>
			<?php if ( ! is_page( 243 ) && ! is_page_template( 'tpl-career-form.php' ) ): ?>
				...
				<?php else: ?>
					<a href="#contact-section" class="header-call js-anchor">Estimate project</a>
				<?php endif; ?>
