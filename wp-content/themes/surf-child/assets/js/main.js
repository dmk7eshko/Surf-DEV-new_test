  ...
  function handleSendEmail() {
    ...
    jQuery.ajax({
      ...
      success: function (result) {
		...
		var successHTML = `
      <div class="success">
        <div class="closer"><img src="/staging/wp-content/themes/surf-child/assets/img/close-white.svg" alt=""></div>
    ...
    `;
        ...
        jQuery.ajax({
          ...
          success: function (data) {
			  jQuery("#sending").replaceWith("<button id='send' class='sendform sendform--white col-sm-12' type='submit'>Get free consultation</button>")
			  ...
			  jQuery("#name").removeClass("filled");
              jQuery("#phone").removeClass("filled");
              jQuery("#email").removeClass("filled");
              jQuery("#msg").removeClass("filled");
              jQuery("#company").removeClass("filled");
          },
        });
      },
    });
