						...
						<div class="project-block">
							<div class="project-person">
								<div class="project-person__image">
									...
									<?= wp_get_attachment_image(get_field('dev_project_img'), [280, 280], null, ['class' => 'project-person__image-avatar']); ?>
								</div>
								<p class="project-person__name"><?= get_field('dev_project_name'); ?></p>
								<span class="project-person__text"><?= get_field('dev_project_pos'); ?></span>
							</div>
							<div class="project-column">
								<h2 class="project__item-title"><?= get_field('dev_project_title'); ?></h2>
