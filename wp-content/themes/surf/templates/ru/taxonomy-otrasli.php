		...
		<div class="container">
			...
			<div class="primary" style="display:block;">
				<div class="filter-inputs">
					...
					<div class="block-inputs getall" data-url="/cases/">Все кейсы</div>
					...
					<?php
						...
						if ( $terms && ! is_wp_error( $terms ) ) {
							foreach ( $terms as $term ) {
								...
								echo '<div class="block-inputs branch' . $current . '" data-url="'. get_category_link($term) . '" data-id="' . $term->term_id . '" >' . $term->name . '</div>';
							}
						}
						...
						if ( $terms && ! is_wp_error( $terms ) ) {
							foreach ( $terms as $term ) {
								$current = ($term->term_id === $current_term->term_id ? ' selected' : '');
								echo '<div class="block-inputs type' . $current . '" data-url="'. get_category_link($term) . '" data-id="' . $term->term_id . '" >' . $term->name . '</div>';
							}
						}
					?>
				</div>
