		...
		<div class="container">
			...
			<div class="primary" style="display:block;">
				...
				<div class="filter-inputs">
					...
					<div class="block-inputs getall selected" data-url="/cases/">Все кейсы</div>
				...
				<!-- <?php if ( $wp_query->max_num_pages > 1 ) : ?>
								...
								<div id="true_loadmore"><div class="get-more">
									<div class="more">
										<a>Показать еще больше кейсов <img src="/wp-content/themes/surf/img/more.svg" alt=""></a> 
									</div>
								</div></div>
						<?php endif; ?> -->
			</div>
